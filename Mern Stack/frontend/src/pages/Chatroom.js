...
function Chatroom({socket}) {
  ...
  const fetchRooms = async () => {
    const response = await fetch("${process.env.REACT_APP_BACKEND_URL}/api/user/room_num", {
      method: 'GET',
      headers: {
  ...
  const fetchMessages = async () => {
    const response = await fetch('${process.env.REACT_APP_BACKEND_URL}/api/message/' + room, {
      method: 'GET',
      headers: {
        'Authorization': `Bearer ${user.token}`
      },
  ...
  const storeMessage = async (messageData) => {
    ...
    const response = fetch('${process.env.REACT_APP_BACKEND_URL}/api/message', {
        method: 'POST',
  ...
  const addRoom = async () => {
    ...
    const response = await fetch('${process.env.REACT_APP_BACKEND_URL}/api/user/join_room', {
      method: 'PATCH',
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${user.token}`,
  ...
  const leaveRoom = async () => {
    ...
    const response = await fetch('${process.env.REACT_APP_BACKEND_URL}/api/user/leave', {
      method: 'PATCH',
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${user.token}`,
  ...
  useEffect(() => {
    if (location.state && location.state.fromRedirect) {
      ...
      const directed = async () => {
          const response = await fetch("${process.env.REACT_APP_BACKEND_URL}/api/user/by_id", {
            method:'PATCH',
            headers: {
              'Content-Type': 'application/json',
              'Authorization': `Bearer ${user.token}`
